...
public class RCDY4CarStop2RunCallableTest {
	@Test
	public void test() throws Exception {
		...
		// 获取数据
		RCDY4CarStop2RunCallable callable = new RCDY4CarStop2RunCallable();
		callable.setFromDate("2012-01-01");// 开始日期: yyyy-MM-dd
