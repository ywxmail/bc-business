...
public class RCDY4DriverHistoryCallableTest {
	@Test
	public void test() throws Exception {
		...
		// 获取数据
		RCDY4DriverHistoryCallable callable = new RCDY4DriverHistoryCallable();
		callable.setFromDate("2013-01-01");// 开始日期: yyyy-MM-dd
		callable.setToDate("2013-02-01");// 结束日期: yyyy-MM-dd
