...
//		attachsUI.setReadOnly(!this.getE().isNew());
	...
	protected GridData buildGridData(List<Column> columns) {
		return super.buildGridData(columns).setRowLabelExpression("['certCode']");
	}
	...
	protected String[] getSearchFields() {
		return new String[] { "cert.certCode", "cert.certName", "car.plateType", "car.plateNo" };
	}
	...
	protected List<Column> buildGridColumns() {
				...
				.setSortable(true).setValueFormater(new AbstractFormater<String>() {
					...
					public String format(Object context, Object value) {
						...
						if(carName.get("plateType") != null){
							return carName.get("plateType")+""+carName.get("plateNo")+""; 
						}else{
							return "";
						}
					}
		...
		columns.add(new TextColumn("['licencer']",	getText("cert.licencer"),100)
				.setSortable(true));
		return columns;
	}
	...
	protected Page<? extends Object> findPage() {
		return this.certService.page4car(
