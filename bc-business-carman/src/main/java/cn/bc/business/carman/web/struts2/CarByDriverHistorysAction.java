	...
	protected Condition getGridSpecalCondition() {
		...
		return ConditionUtils
				.mix2AndCondition(
						statusCondition,
						carManIdCondition,
						(carId2ToCarIdCondition != null
								|| oldCarIdCondition != null
								|| carId2ShiftworkCarIdCondition != null ? ConditionUtils
								.mix2OrCondition(carId2ToCarIdCondition,
										oldCarIdCondition,
										carId2ShiftworkCarIdCondition)
								.setAddBracket(true) : null));
