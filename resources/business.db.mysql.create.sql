...
ALTER TABLE BS_SYNC_JIAOWEI_JTWF ADD CONSTRAINT BSFK_JIAOWEIJTWF2BASE FOREIGN KEY (ID)
      REFERENCES BC_SYNC_BASE (ID);
ALTER TABLE BS_SYNC_JIAOWEI_JTWF ADD INDEX BCIDX_JIAOWEIJTWF_DRIVER_CERT (DRIVER_CERT);
ALTER TABLE BS_SYNC_JIAOWEI_JTWF ADD INDEX BCIDX_JIAOWEIJTWF_CAR_PLATE (CAR_PLATE_TYPE,CAR_PLATE_NO);
...
ALTER TABLE BS_SYNC_JIAOWEI_YYWZ ADD CONSTRAINT BSFK_JIAOWEIYYWZBASE FOREIGN KEY (ID)
      REFERENCES BC_SYNC_BASE (ID);
ALTER TABLE BS_SYNC_JIAOWEI_YYWZ ADD INDEX BCIDX_JIAOWEIYYWZ_CERT (DRIVER_CERT);
...
ALTER TABLE BS_SYNC_JIAOWEI_ADVICE ADD CONSTRAINT BSFK_JIAOWEIADVICEBASE FOREIGN KEY (ID)
      REFERENCES BC_SYNC_BASE (ID);
ALTER TABLE BS_SYNC_JIAOWEI_ADVICE ADD INDEX BCIDX_JIAOWEIADVICE_CERT (DRIVER_CERT);
...
ALTER TABLE BC_MEMBER ADD CONSTRAINT BCFK_MEMBER_AUTHOR FOREIGN KEY (AUTHOR_ID)
      REFERENCES BC_IDENTITY_ACTOR_HISTORY (ID);
ALTER TABLE BC_MEMBER ADD CONSTRAINT BCFK_MEMBER_MODIFIER FOREIGN KEY (MODIFIER_ID)
      REFERENCES BC_IDENTITY_ACTOR_HISTORY (ID);
ALTER TABLE BC_MEMBER ADD UNIQUE INDEX BCUK_MEMBER_CODE (CODE);
ALTER TABLE BC_MEMBER ADD UNIQUE INDEX BCUK_MEMBER_MEMBER (MEMBER_TYPE,MEMBER_ID);
ALTER TABLE BC_MEMBER ADD INDEX BCIDX_MEMBER_CARD (CARD_ID);

-- 考勤安排
CREATE TABLE BC_ARRANGE(
   ID                   BIGINT NOT NULL,
   UID_                 VARCHAR(36) NOT NULL,
...
ALTER TABLE BC_ARRANGE ADD CONSTRAINT BCFK_ARRANGE_AUTHOR FOREIGN KEY (AUTHOR_ID)
      REFERENCES BC_IDENTITY_ACTOR_HISTORY (ID);
ALTER TABLE BC_ARRANGE ADD CONSTRAINT BCFK_ARRANGE_MODIFIER FOREIGN KEY (MODIFIER_ID)
      REFERENCES BC_IDENTITY_ACTOR_HISTORY (ID);
ALTER TABLE BC_ARRANGE ADD INDEX BCIDX_UNIT_STATUS (UNIT_ID,STATUS_);

-- 安排的成员
CREATE TABLE BC_ARRANGE_MEMBER(
   ID                   BIGINT NOT NULL,
...
ALTER TABLE BC_ARRANGE_MEMBER ADD CONSTRAINT BCFK_AMEMBER_AUTHOR FOREIGN KEY (AUTHOR_ID)
      REFERENCES BC_IDENTITY_ACTOR_HISTORY (ID);
ALTER TABLE BC_ARRANGE_MEMBER ADD CONSTRAINT BCFK_AMEMBER_MODIFIER FOREIGN KEY (MODIFIER_ID)
      REFERENCES BC_IDENTITY_ACTOR_HISTORY (ID);
ALTER TABLE BC_ARRANGE_MEMBER ADD CONSTRAINT BCFK_AMEMBER_ARRANGE FOREIGN KEY (PID)
      REFERENCES BC_ARRANGE (ID);
ALTER TABLE BC_ARRANGE_MEMBER ADD INDEX BCUK_AMEMBER_MEMBER (MEMBER_ID);
ALTER TABLE BC_ARRANGE_MEMBER ADD INDEX BCIDX_AMEMBER_COUNT (SIGN_COUNT);

-- 成员的签到记录
CREATE TABLE BC_SIGN_RECORD(
   ID                   BIGINT NOT NULL,
   PID                  BIGINT COMMENT '隶属ID',
   DATA_TYPE            INT(1) NOT NULL COMMENT '数据分类：0-安全学习,1-回场检',
   SIGN_TYPE            INT(1) NOT NULL COMMENT '签到方式：0-手工补录,1-考勤机',
...
ALTER TABLE BC_SIGN_RECORD ADD CONSTRAINT BCFK_RECORD_AUTHOR FOREIGN KEY (AUTHOR_ID)
      REFERENCES BC_IDENTITY_ACTOR_HISTORY (ID);
ALTER TABLE BC_SIGN_RECORD ADD CONSTRAINT BCFK_RECORD_MEMBER FOREIGN KEY (PID)
      REFERENCES BC_ARRANGE_MEMBER (ID);
ALTER TABLE BC_SIGN_RECORD ADD INDEX BCIDX_RECORD_CODE (CODE);
ALTER TABLE BC_SIGN_RECORD ADD INDEX BCIDX_RECORD_CARD (CARD_ID);
...
CREATE TABLE BS_ARRANGE_DRIVER(
   ...
   CAR_ID               BIGINT NOT NULL COMMENT '车辆ID',
   CAR_PLATE            VARCHAR(255) NOT NULL COMMENT '车牌：粤A.XXXX',
...
ALTER TABLE BS_ARRANGE_DRIVER ADD CONSTRAINT BSFK_ADRIVER_CAR FOREIGN KEY (CAR_ID)
      REFERENCES BS_CAR (ID);
ALTER TABLE BS_ARRANGE_DRIVER ADD INDEX BCIDX_ADRIVER_UNITM (UNIT_ID,MOTORCADE_ID);
ALTER TABLE BS_ARRANGE_DRIVER ADD INDEX BCIDX_ADRIVER_CARPLATE (CAR_PLATE);
ALTER TABLE BS_ARRANGE_DRIVER ADD INDEX BCIDX_ADRIVER_CARDNO (CARD_NO);
