...
ALTER TABLE BS_CAR ADD CONSTRAINT FK_FEEDBACK_AUTHOR FOREIGN KEY (AUTHOR_ID) 
	REFERENCES BC_IDENTITY_ACTOR (ID);
ALTER TABLE BS_CAR ADD INDEX IDX_FEEDBACK_SEARCH (UNIT_ID,STATUS_);
ALTER TABLE BS_CAR ADD INDEX IDX_FEEDBACK_ARCHIVE (UNIT_ID,STATUS_,FILE_YEAR,FILE_MONTH,FILE_DAY);
