...
ALTER TABLE BC_SIGN_RECORD ADD INDEX BSIDX_RECORD_CODE (CODE);
ALTER TABLE BC_SIGN_RECORD ADD INDEX BSIDX_RECORD_CARD (CARD_ID);
...
ALTER TABLE BS_ARRANGE_DRIVER ADD INDEX BSIDX_ADRIVER_CARPLATE (CAR_PLATE);
