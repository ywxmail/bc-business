...
CREATE TABLE BS_SYNC_JINDUN_JTWF (
    ...
    CAR_PLATE varchar2(100) NOT NULL,
    ENGINE_NO varchar2(255),
    HAPPEN_DATE DATE NOT NULL,
    ADDRESS varchar2(1000),
    DRIVER_NAME varchar2(255),
    JEOM number(4,1) NOT NULL,
    PENALTY number(4,1) NOT NULL,
    OVERDUE_PAYMENT number(4,1) NOT NULL,
...
COMMENT ON COLUMN BS_SYNC_JINDUN_JTWF.CAR_PLATE IS '车牌号码';
...
ALTER TABLE BS_SYNC_JINDUN_JTWF ADD CONSTRAINT BSFK_JINDUNJTWF2BASE FOREIGN KEY (ID)
      REFERENCES BC_SYNC_BASE (ID);
CREATE INDEX BCIDX_JINDUNJTWF_CAR ON BS_SYNC_JINDUN_JTWF (CAR_PLATE);
