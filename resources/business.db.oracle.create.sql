...
COMMENT ON TABLE BS_CAR_POLICY IS '黑名单';
...
(
   ...
   MODIFIER_ID          NUMBER(19),
   MODIFIED_DATE        DATE,
   CONSTRAINT PK_BS_INSURANCE_TYPE PRIMARY KEY (ID)
);
COMMENT ON TABLE BS_INSURANCE_TYPE IS '车辆保单';
...
ALTER TABLE BS_SYNC_JIAOWEI_JTWF ADD CONSTRAINT BSFK_JIAOWEIJTWF2BASE FOREIGN KEY (ID)
      REFERENCES BC_SYNC_BASE (ID);
CREATE INDEX BCIDX_JIAOWEIJTWF_CERT ON BCIDX_JIAOWEIJTWF_CERT (DRIVER_CERT);
CREATE INDEX BCIDX_JIAOWEIJTWF_CERT ON BCIDX_JIAOWEIJTWF_CAR (CAR_PLATE_TYPE,CAR_PLATE_NO);
...
ALTER TABLE BS_SYNC_JIAOWEI_YYWZ ADD CONSTRAINT BSFK_JIAOWEIYYWZBASE FOREIGN KEY (ID)
      REFERENCES BC_SYNC_BASE (ID);
CREATE INDEX BCIDX_JIAOWEIYYWZ_CERT ON BCIDX_JIAOWEIYYWZ_CERT (DRIVER_CERT);
...
ALTER TABLE BS_SYNC_JIAOWEI_ADVICE ADD CONSTRAINT BSFK_JIAOWEIADVICEBASE FOREIGN KEY (ID)
      REFERENCES BC_SYNC_BASE (ID);
CREATE INDEX BCIDX_JIAOWEIADVICE_CERT ON BCIDX_JIAOWEIADVICE_CERT (DRIVER_CERT);
