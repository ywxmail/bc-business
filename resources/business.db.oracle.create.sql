...
COMMENT ON COLUMN BS_CONTRACT_LABOUR.HAPPEN_DATE IS '事发时间';
COMMENT ON COLUMN BS_CONTRACT_LABOUR.IS_OAS IS '是否门诊';
COMMENT ON COLUMN BS_CONTRACT_LABOUR.IS_IN_HOSPITAL IS '是否住院';
COMMENT ON COLUMN BS_CONTRACT_LABOUR.IS_LI IS '是否劳动鉴别';
