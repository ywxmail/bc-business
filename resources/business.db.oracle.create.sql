...
COMMENT ON COLUMN BS_CONTRACT.STATUS_ IS'状态：0-正常,1-离职';
...
(
   ...
   CERT_IDENTITY        VARCHAR2(255)        NOT NULL,
   SEX                  NUMBER(1),
   BIRTHDATE            DATE,
   AGE                  NUMBER(3),
   ORIGIN               VARCHAR2(255),
...
COMMENT ON COLUMN BS_CONTRACT_LABOUR.INSURANCE_TYPE IS '社保险种(1-五金,2-工伤)';
...
ALTER TABLE BS_INDUSTRIAL_INJURY ADD CONSTRAINT BSFK_INDUS_REFERENCE_BC_IDENT FOREIGN KEY (AUTHOR_ID)
      REFERENCES BC_IDENTITY_ACTOR_HISTORY (ID);
ALTER TABLE BS_INDUSTRIAL_INJURY ADD CONSTRAINT BSFK_INDUS_REFERENCE_BC_IDENT FOREIGN KEY (MODIFIER_ID)
      REFERENCES BC_IDENTITY_ACTOR_HISTORY (ID);
