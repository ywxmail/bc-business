...
CREATE TABLE BS_SYNC_INFRACT_TRAFFIC (
    ID number(19) NOT NULL,
    HAPPEN_DATE DATE NOT NULL,
    CAR_PLATE varchar2(255) NOT NULL,
    DRIVER_CERT varchar2(255),
    DRIVER_NAME varchar2(255),
    JEOM number(4,1) NOT NULL,
    COMPANY_NAME varchar2(255),
    CONTENT varchar2(4000) NOT NULL,
    CONSTRAINT BSPK_SYNC_INFRACT_TRAFFIC PRIMARY KEY (ID)
);
COMMENT ON TABLE BS_SYNC_INFRACT_TRAFFIC IS '交委WebService接口的交通违章信息';
COMMENT ON COLUMN BS_SYNC_INFRACT_TRAFFIC.HAPPEN_DATE IS '违章时间';
COMMENT ON COLUMN BS_SYNC_INFRACT_TRAFFIC.CONTENT IS '违章内容';
COMMENT ON COLUMN BS_SYNC_INFRACT_TRAFFIC.CAR_PLATE IS '车牌号码';
COMMENT ON COLUMN BS_SYNC_INFRACT_TRAFFIC.DRIVER_NAME IS '当事司机姓名';
COMMENT ON COLUMN BS_SYNC_INFRACT_TRAFFIC.DRIVER_CERT IS '服务资格证';
COMMENT ON COLUMN BS_SYNC_INFRACT_TRAFFIC.JEOM IS '本次扣分';
ALTER TABLE BS_SYNC_INFRACT_TRAFFIC ADD CONSTRAINT BSFK_SYNCTRAFFIC2BASE FOREIGN KEY (ID)
      REFERENCES BC_SYNC_BASE (ID);
CREATE INDEX BCIDX_SYNCTRAFFIC_CERT ON BS_SYNC_INFRACT_TRAFFIC (DRIVER_CERT);
